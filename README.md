...
For a complete overview of our pipeline—from fuzz scenarios to fault trees—as applied to our System under Test (SuT), see [Pipeline Flowchart](RQ2.md#pipeline-reduction-from-scenarios-to-fault-trees) for the diagram and a detailed example.
